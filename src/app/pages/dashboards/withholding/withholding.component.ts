...
@Component({
  ...
  styleUrls: ['./withholding.component.scss']
})
export class WithholdingComponent {
        ...
        filtrarVouchersPorTipoFactura(): void {
          const tipoFacturaBuscado = 'COMPROBANTE_RETENCION';
        ...
        filtrarPorEstado(estado: string): void {
          ...
          if (estado.trim() === '') {
            ...
            this.filteredVouchers = this.allVouchers.filter(voucher => voucher.voucherType === 'COMPROBANTE_RETENCION' && voucher.status === estado.trim());
